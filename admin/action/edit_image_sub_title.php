...
$folderPath = "../uploads/$e_id/$blog_now/sub_title/$sub/";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['sub_title_pic_' . $blog_now . '_' . $sub])) {
    ...
    if (in_array($fileExtension, $allowedExtensions)) {
        ...
        $uploadPath = $baseFolderPath . "$blog_now/sub_title/$sub/$newFileName";
    ...
    $_SESSION['sub_title_pic_' . $blog_now . '_' . $sub] = "uploads/$e_id/$blog_now/sub_title/$sub/$newFileName";
...
$folderName = $baseFolderPath . "$blog_now/sub_title/$sub/";
